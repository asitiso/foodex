  ...
  return (
    <header className="game-hud">
      ...
      <div className="game-status-rail" aria-label="오늘의 게임 상태">
        <button className="game-status-button game-status-level" data-testid="game-hud-status" type="button" aria-label={`레벨 ${level}, 성장 ${levelProgress}%`} onClick={onOpenLevel}>
        ...
        <button className="game-status-button game-status-cards" data-testid="game-hud-status" type="button" aria-label={`오늘의 카드 ${todayCards}장`} onClick={onOpenCards}>
        ...
        <button className="game-status-button game-status-meals" data-testid="game-hud-status" type="button" aria-label={`오늘 식사 ${todayMeals}회 목표 ${mealTarget}회 연속 ${streakDays}일`} onClick={onOpenMeals}>
