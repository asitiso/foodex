...
export function AdventureScreen({ progression, worldProgress = buildWorldProgress([]), gameLoop }: { progression: Progression; worldProgress?: WorldProgress; gameLoop?: GameLoopProgress }) {
