...
export function AdventureScreen({ progression, worldProgress = buildWorldProgress([]) }: { progression: Progression; worldProgress?: WorldProgress }) {
